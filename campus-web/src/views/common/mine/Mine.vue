<template>
  <div class="mine-page">
    ...
    <div class="quick-stats">
      <div class="stat-item" @click="goTo(isTeacher ? '/teacher/orders' : '/parent/students')">
        <div class="stat-value">{{ stats.studentCount || 0 }}</div>
        <div class="stat-label">{{ isTeacher ? '接单数' : '我的学生' }}</div>
      </div>
      <div class="stat-item" @click="goTo(isTeacher ? '/teacher/lessons' : '/parent/demands')">
        <div class="stat-value">{{ stats.demandCount || 0 }}</div>
        <div class="stat-label">{{ isTeacher ? '课时数' : '发布的需求' }}</div>
      </div>
      <div class="stat-item" @click="goTo(isTeacher ? '/teacher/orders' : '/parent/orders')">
    ...
    <div class="menu-section">
      <div class="menu-group">
        <div class="menu-item" @click="goTo(isTeacher ? '/teacher/wallet' : '/parent/wallet')">
        ...
        <div class="menu-item" @click="goTo(isTeacher ? '/teacher/orders' : '/parent/orders')">
        ...
        <div class="menu-item" @click="goTo(isTeacher ? '/teacher/lessons' : '/parent/lessons')">
      ...
      <div class="menu-group">
        <div class="menu-item" @click="goTo(isTeacher ? '/teacher/resume' : '/parent/students')">
          <div class="menu-icon" style="background: linear-gradient(135deg, #4facfe, #00f2fe)">
            <el-icon><User /></el-icon>
          </div>
          <div class="menu-text">{{ isTeacher ? '我的简历' : '学生管理' }}</div>
          <el-icon><ArrowRight /></el-icon>
        </div>
        
        <div class="menu-item" @click="goTo(isTeacher ? '/teacher/home' : '/parent/demands')">
          <div class="menu-icon" style="background: linear-gradient(135deg, #fa709a, #fee140)">
            <el-icon><Edit /></el-icon>
          </div>
          <div class="menu-text">{{ isTeacher ? '找学生' : '我的需求' }}</div>
          <el-icon><ArrowRight /></el-icon>
        </div>
        
        <div class="menu-item" @click="goTo('/ai')">
