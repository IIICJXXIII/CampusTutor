...
const handleSubmit = async () => {
  ...
  try {
    const certData = {
      ...
      major: form.major,
      // 后端必填字段：未做身份证上传，这里填充占位符以便联调
      idCard: '000000000000000000',
      idCardFrontUrl: form.studentCardUrl || 'mock-front',
      idCardBackUrl: form.studentCardUrl || 'mock-back',
      education: 2,
      enrollYear: form.enrollYear || new Date().getFullYear(),
      studentCardUrl: form.studentCardUrl || 'mock-student-card',
