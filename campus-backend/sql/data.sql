...
(102, '李娜', '北京外国语大学', '英语', 3, '["英语"]', '["小学全科","初一","初二"]', 120.00, 116.315055, 39.957583, '北京市海淀区西三环北路2号', 2, 4.8, '专八水平，口语流利，有两年少儿英语教学经验', '活泼生动，寓教于乐', 1, 1),
...
(105, '孙浩', '中国人民大学', '经济学', 3, '["数学","英语"]', '["小学全科"]', 90.00, 116.316833, 39.971556, '北京市海淀区中关村大街59号', 1, 4.5, '喜欢孩子，有耐心，善于沟通', '轻松愉快', 1, 1),
(106, '周婷', '北京理工大学', '应用数学', 3, '["数学"]', '["初一","初二","高一","高二"]', 130.00, 116.321111, 39.960000, '北京市海淀区中关村南大街5号', 2, 4.8, '逻辑清晰，善于总结考点', '注重基础，稳扎稳打', 1, 1),
(107, '吴刚', '北京复旦大学', '汉语言文学', 4, '["语文","历史"]', '["小学全科","初一"]', 110.00, 116.300000, 39.980000, '北京市海淀区', 2, 4.6, '文学功底深厚，作文辅导经验丰富', '文采飞扬，启发式教学', 1, 1),
...
(111, '林风', '清华大学', '计算机', 3, '["数学","编程"]', '["初中全科"]', 180.00, 0, 0.0), -- 待提交
(112, '黄芸', '北京大学', '新闻', 2, '["语文","英语"]', '["小学全科"]', 100.00, 1, 0.0), -- 待审核
(113, '刘星', '复旦大学', '物理', 4, '["物理"]', '["高中全科"]', 200.00, 3, 0.0), -- 已拒绝
(114, '张月', '上海交大', '英语', 3, '["英语"]', '["初中全科"]', 120.00, 2, 5.0),
(115, '徐阳', '浙江大学', '数学', 4, '["数学"]', '["高中全科"]', 160.00, 2, 4.8);
